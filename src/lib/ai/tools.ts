...
/**
 * Returns the appropriate tool definitions based on the current mode.
 * Buy mode gets search and clarification tools.
 * Sell mode gets listing creation and analysis tools.
 */
export function getToolDefinitions(mode: "buy" | "sell"): OpenAI.ChatCompletionTool[] {
  if (mode === "buy") {
    return [
